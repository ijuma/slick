...
class QueryableTest(val tdb: TestDB) extends DBTest {
  ...
  @Test def test() {
    ...
    */
    ...
    // BLOCKED by "[error] D:\work\scala-query\src\test\scala\scala\slick\test\queryable\QueryableTest.scala:208: failed to typecheck against macro def return type: not found: value free$q8 at source-D:\work\scala-query\src\test\scala\scala\slick\test\queryable\QueryableTest.scala"
